...
const url = "mongodb+srv://codyclackclack:JESUSfan15@cluster0.tb1gxvb.mongodb.net/?retryWrites=true&w=majority"//process.env.MONGO_URI;
...
app.use(express.static(path.join(__dirname, 'build')))
  ...
  app.post("/login", (req, res) => {
    ...
    if (req.body.passcode === "1234"){//process.env.PASS_KEY) {
